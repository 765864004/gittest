<?php if (!defined('THINK_PATH')) exit();?><div class="pageHeader">
    <form id="pagerForm" action="<?php echo U('admin/dictionary_manage/unitlist');?>" method="post" class="pageForm required-validate" onSubmit='return navTabSearch(this);'>
...
<div class="pageContent">
	<div class="panelBar">
	    <ul class="toolBar">
	        <li><a class="add" href="<?php echo U('admin/dictionary_manage/unitadd');?>" target="dialog" width="510" height="200" mask=true title='添加部件'><span>添加</span></a></li>
	        <li><a class="edit" href="<?php echo U('admin/dictionary_manage/unitedit');?>?id={sid}" target="dialog" width="510" height="200" mask=true warn="您没有选中" title='编辑部件'><span>修改</span></a></li>
	        <li class="line">line</li>
	        <li><a class="delete" href="<?php echo U('admin/dictionary_manage/unitProcess');?>?id={sid}&actType=del" target="ajaxTodo" warn="您没有选中" title="确定要删除吗？"><span>删除</span></a></li>
	        <li class="line">line</li>
	    </ul>
	</div>
    <table class="table" width="99%" layoutH="117" targetType="navTab" asc="asc" desc="desc">
           <thead>
                <tr>
                    ...
                    <th align='center'>部件名称</th>
                    <th align='center'>车型</th>
                    <th align='center'>所属部位</th>
         ...
         <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="sid" rel="<?php echo ($vo['id']); ?>">
                    ...
                    <td align='center'><?php echo ($vo['unitname']); ?></td>
