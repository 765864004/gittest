<?php if (!defined('THINK_PATH')) exit();?><div class="pageHeader">
    <form id="pagerForm" action="<?php echo U('admin/dictionary_manage/materialList');?>" method="post" class="pageForm required-validate" onSubmit='return navTabSearch(this);'>
...
<div class="pageContent">
	...
	<div class="panelBar">
	    <ul class="toolBar">
	        <li><a class="add" href="<?php echo U('admin/dictionary_manage/materialAdd');?>" target="dialog" width="510" height="150" mask=true title='添加材料'><span>添加</span></a></li>
	        <li><a class="edit" href="<?php echo U('admin/dictionary_manage/materialEdit');?>?id={sid}" target="dialog" width="510" height="150" mask=true warn="您没有选中" title='编辑材料'><span>修改</span></a></li>
	        <li class="line">line</li>
	        <li><a class="delete" href="<?php echo U('admin/dictionary_manage/materialProcess');?>?id={sid}&actType=del" target="ajaxTodo" warn="您没有选中" title="确定要删除吗？"><span>删除</span></a></li>
	        <li class="line">line</li>
	    </ul>
	</div>
